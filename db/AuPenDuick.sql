...
--
-- Hôte : localhost
-- Généré le :  ven. 20 oct. 2017 à 10:30
...
INSERT INTO `category` (`id`, `name`, `picture`, `type_id`) VALUES
(1, 'Carte de galettes de sarrasin bio (sans gluten)', '', 1),
(2, 'Crêpes de froment Bio', '', 2),
(3, 'Carte de galettes de sarrasin bio (sans gluten)', '', 2);
...
INSERT INTO `compagny` (`id`, `header`, `header_2`, `event`, `about_us`, `telephone`) VALUES
...
INSERT INTO `food` (`id`, `description`, `price`, `category_id`) VALUES
...
(11, 'J.Cook – Epinards frais, chèvre en crottin, Miel V', 7.9, 1),
...
(37, 'Guadeloupe – Banane rôtie, Flambée Rhum', 7.9, 2),
(38, 'Bora Bora – Beurre salé, zest d’orange Bio, Flambée Grand Marnier', 7, 2),
(39, 'Tatihou – Pomme caramélisée, Caramel beurre salé, Flambée Calvados', 7.9, 2),
(40, 'Rangiroa – Chocolat Maison, Zest d’orange bio, Flambée Cointreau', 7, 2),
(41, 'Supplément Chantilly maison', 2, 2),
(42, 'Supplément boule de glace', 1.5, 2);
