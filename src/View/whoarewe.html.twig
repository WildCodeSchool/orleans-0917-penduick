<section class="fontsSegoe">
    <div class="fondbody">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h1 class="titleHeader"><?= $displayText[1] ?></h1><hr/>
                    <p><?= $displayText[2] ?></p><hr/>
                    <button type="button" class="btnHeader"><strong>VOIR LA CARTE</strong></button>
                </div>
            </div>
        </div>
        ...
        <div class="bio">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <p class="aboutUs"><?= $displayText[3] ?></p>
                    </div>
                </div>
            </div>
        </div>
